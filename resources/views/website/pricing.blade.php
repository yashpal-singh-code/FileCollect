...
<head>
    ...
    <title>FileCollect | Secure Automated Document Collection for Professionals</title>
...
<body class="bg-slate-50 text-slate-900">
    ...
    <section class="gradient-bg text-white py-24 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            <div data-aos="fade-right">
                <div
                    class="inline-flex items-center gap-2 px-4 py-1.5 mb-6 text-xs font-bold tracking-wider uppercase bg-white/20 rounded-full">
                    <x-lucide-rocket class="w-5 h-5" />
                    Trusted by growing teams
                </div>
                <h1 class="text-5xl lg:text-6xl font-extrabold mb-6 leading-tight">
                    Stop Chasing Files. <br><span class="text-blue-200">Start Closing Deals.</span>
                </h1>
                <p class="text-xl opacity-90 mb-10 leading-relaxed max-w-xl">
                    A secure client document portal for accountants, lawyers, consultants, and businesses to collect and
                    manage files in one place.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#"
                        class="bg-white text-blue-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-blue-50 transition shadow-2xl flex items-center justify-center">
                        Get Started Free
                    </a>
                </div>
            ...
            <div data-aos="fade-left" class="relative">
                <div class="bg-slate-900/20 absolute inset-0 blur-3xl rounded-full"></div>
                <div class="relative glass-card rounded-2xl shadow-2xl p-4 border border-white/40">
                    <div class="space-y-4">
                        <div class="flex justify-between items-center bg-blue-50 p-3 rounded-lg border border-blue-100">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white text-xs">
                                    PDF</div>
                                <span class="text-sm font-semibold text-slate-700">Tax_Return_2026.pdf</span>
                            </div>
                            <span class="text-xs font-bold text-blue-600 bg-blue-100 px-2 py-1 rounded">Received</span>
                        </div>
                        <div class="flex justify-between items-center bg-white p-3 rounded-lg border border-slate-100">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-8 h-8 bg-slate-200 rounded flex items-center justify-center text-slate-500 text-xs">
                                    IMG</div>
                                <span class="text-sm font-semibold text-slate-700">Driver_License.jpg</span>
                            </div>
                            <span class="text-xs font-bold text-amber-600 bg-amber-100 px-2 py-1 rounded">Pending</span>
                        </div>
                        <div
                            class="h-32 bg-slate-50 rounded-lg border-2 border-dashed border-slate-200 flex items-center justify-center text-slate-400 text-sm italic">
                            Client is uploading... 75%
                        </div>
                    </div>
                </div>
            </div>
